...
if __name__ == "__main__":
    ...
    data_set = pd.read_csv(
        r'D:\Study\py\国赛代码\iris_classification_BPNeuralNetwork-master\bpnn_V2数据集\iris_training.csv', header=None)
    ...
    data_test = pd.read_csv(
        r'D:\Study\py\国赛代码\iris_classification_BPNeuralNetwork-master\bpnn_V2数据集\iris_test.csv', header=None)
